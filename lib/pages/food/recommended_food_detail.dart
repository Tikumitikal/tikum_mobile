        ...
        slivers: [
          SliverAppBar(
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                child: Center(
                    child: BigText(size: Dimensions.font26, text: "Sanger")),
            ...
            pinned: true,
            backgroundColor: AppColors.TikumColor,
            expandedHeight: 300,
            flexibleSpace: FlexibleSpaceBar(
              background: Image.asset(
                "assets/images/sanger.jpg",
                width: double.maxFinite,
                fit: BoxFit.cover,
              ),
            ),
          ...
          child: Row(
            ...
            children: [
              AppIcon(
                  ...
                  backgroundColor: AppColors.TikumColor,
                  icon: Icons.remove),
              BigText(text: " 15\k "+" x "+" 0 ", color: AppColors.mainBlackColor, size: Dimensions.font26,),
              AppIcon(
                  iconSize: Dimensions.iconSize24,
                  iconColor: Colors.white,
                  backgroundColor: AppColors.TikumColor,
